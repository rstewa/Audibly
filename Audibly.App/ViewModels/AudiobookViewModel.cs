...
namespace Audibly.App.ViewModels
{
    ...
    public class AudiobookViewModel : BindableBase, IEditableObject
    {
        ...
        /// </summary>
        public AudiobookViewModel(Audiobook model = null) => Model = model ?? new Audiobook();
        ...
        // todo: modify this to select the correct glyph based on the value of Volume
        /// <summary>
        ...
        {
            get => Model.CurrentChapter;
            set
            {
                if (value != Model.CurrentChapter)
                {
                    Model.CurrentChapter = value;
                    IsModified = true;
                    OnPropertyChanged();
                }
            }
