...
namespace Audibly.App.Helpers.IconUtils
{	
	// from: https://github.com/rmcrackan/Libation/blob/master/Source/LoadByOS/WindowsConfigApp/FolderIcon.cs
	internal static partial class FolderIcon
	{
		public static void SetFolderIcon(string image, string directory)
		{
