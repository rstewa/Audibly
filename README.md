...
![Audibly-screenshot1](screenshots\audibly_11.PNG)

![Audibly-screenshot2](screenshots\audibly_11.PNG)

Here's a blank template to get started: To avoid retyping too much info. Do a search and replace with your text editor for the following: `rstewa35`, `Audibly`, `twitter_handle`, `linkedin_username`, `email_client`, `email`, `project_title`, `project_description`
